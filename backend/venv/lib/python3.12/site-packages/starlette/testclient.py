...
class TestClient(httpx.Client):
    ...
    def websocket_connect(
        ...
        # SECURITY NOTE: Using ws:// (non-secure WebSocket) is intentional here.
        # This is a test client connecting to a mock "testserver" for unit testing.
        # In production, applications should use wss:// for secure WebSocket connections.
        # The test environment doesn't require SSL/TLS encryption for mock connections.
